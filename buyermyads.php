...
$result = mysqli_query($link, "select cropid,cropname,imagename,description,quantity from buycrop WHERE bid=$bid");
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit">
        ...
        <div id="header"></div>        
            ...
            <ul>
                 ...
                 <li><a  class="active" href="buyermyads.php">view My Ads</a></li>
 ...
 function deletead(str) {
  ...
  xhttp.open("GET","deletebuyerad.php?q="+str, true);
  xhttp.send();
}
