...
if(isset($_POST['btnLogin']))
{
    ...
    $pwd = $_POST['txtPwd'];
   $result = mysqli_query($link, "select * from shopinfo where email='" . $email . "' and pwd='" . md5($pwd) . "'");
   ...
   if($count>0)
   {
       ...
       echo "<script>alert('Login Successfully...!'); window.location='shopperhome.php';</script>";
    ...
    setTimeout(carousel, 2000);
        ...
        <div id="menu">
            <ul>
                ...
                <li><a class="active" href="shopperlogin.php">Shopper Login</a></li>
        ...
        <div id="content">
           ...
           <form method="post">
                ...
                <th> <td colspan="2" > <h2>Shopper Login</h2></td><td></td></th>
            <tr><td>&nbsp;</td></tr>
            ...
            <tr><td></td></tr>
            <tr><td></td></tr>
            <tr>&nbsp;<td></td><td align="right">New User...?   <a href="fertilizerSellerReg.php"> Sign Up</a></td></tr>
