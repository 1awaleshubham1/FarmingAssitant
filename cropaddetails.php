...
include_once './dbconfig.php';
   ...
   $result = mysqli_query($link, "select cropname,imagename,description,quantity,(select fname from supplierinfo where id=s.bid)as fname,(select cno from supplierinfo where id=s.bid)as cno,(select location from supplierinfo where id=s.bid)as location from buycrop s  ;");
 ?>
<html>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit">
        ...
        <div id="header"></div>        
             ...
             <div id="menu">
            <ul>
                <li><a class="active" href="cropaddetails.php">Buyer Advertisement Details</a></li>
	...
	<table class="data-table">
		...
		while ($row = mysqli_fetch_array($result))
		{
			...
			echo '<tr>
					<td>'.$row['cropname'].'</td>
                                        <td> <img src="uploads2/'.$row['imagename'].'" alt=" " height="150" width="150"> </td>                                
