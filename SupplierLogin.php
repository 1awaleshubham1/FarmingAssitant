    ...
    if(isset($_POST['btnLogin']))
{
    ...
    $pwd = $_POST['txtPwd'];
   $result = mysqli_query($link, "select * from Supplierinfo where email='" . $email . "' and pwd='" . md5($pwd) . "'");
   ...
   if($count>0)
   {
       session_start();
       $_SESSION['id']=$bid;
       echo "<script>alert('Login Successfully...!'); window.location='SupplierPanel.php';</script>";
    ...
    setTimeout(carousel, 2000);
        ...
        <div id="menu">
            ...
            <ul>
                ...
                <li><a class="active" href="SupplierLogin.php">Buyer Login</a></li>
        ...
        <div id="content">
            ...
            <table align="center">
                ...
                <th> <td colspan="2" > <h2> Buyer Login </h2></td><td></td></th>
            <tr><td>&nbsp;</td></tr>
            ...
            <tr> <td>&nbsp;</td><td align="right" ><input type="submit" value="Login" name="btnLogin" /></td></tr>
              <tr><td></td></tr>
               <tr><td></td></tr>
            <tr> <td>&nbsp;</td><td align="right">New User...?    <a href="SupplierRegister.php">Sign Up</a></td></tr>
